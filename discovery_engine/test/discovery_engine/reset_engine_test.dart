...
void main() {
  group('DiscoveryEngine resetEngine', () {
    test(
      ...
      expect(engine.resetEngine(), completion(isA<ClientEventSucceeded>()));
    });
    ...
    test(
      ...
      final response = await engine.resetEngine();
...
void withErrorResponse(Object initialMessage) => MockDiscoveryEngineWorker(
      initialMessage,
      resetEngineResponse: const EngineEvent.engineExceptionRaised(
        EngineExceptionReason.genericError,
      ),
    );
...
void withWrongEventResponse(Object initialMessage) => MockDiscoveryEngineWorker(
      initialMessage,
      resetEngineResponse: const EngineEvent.nextFeedBatchAvailable(),
    );
