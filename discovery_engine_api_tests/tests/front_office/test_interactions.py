...
class TestInteractions:
    ...
    def test_positive_interaction(self, ingest_generated_document):
        user_id = tu.generate_random_alphanumerical(6)
        positive_interaction = Interactions(Interaction(id=ingest_generated_document, type="Positive")).to_json()
    ...
    def test_invalid_doc_id(self):
        user_id = tu.generate_random_alphanumerical(6)
        interaction_with_random_id = Interactions(tu.generate_random_alphanumerical(36), "Positive").to_json()
    ...
    def test_invalid_user_id(self, ingest_generated_document):
        ...
        interaction = Interactions(Interaction(ingest_generated_document, "Positive")).to_json()
    ...
    def test_interaction_with_null_values(self, ingest_generated_document):
        ...
        interaction_with_null_type = Interactions(Interaction(id=ingest_generated_document, type=None)).to_json()
