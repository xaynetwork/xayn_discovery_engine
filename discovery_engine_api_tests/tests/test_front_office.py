...
class TestFrontOffice:
    ...
    def test_interaction(self, ingest_generated_documents):
        user_id = su.generate_random_alphanumerical(6)
        interaction = Interactions(Interaction(id=ingest_generated_documents)).to_json()
    ...
    def test_invalid_doc_id(self):
        user_id = su.generate_random_alphanumerical(6)
        interaction_with_random_id = Interactions(su.generate_random_alphanumerical(36)).to_json()
